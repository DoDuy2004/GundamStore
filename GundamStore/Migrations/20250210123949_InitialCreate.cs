        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    listcontent = table.Column<string>(type: "ntext", nullable: true),
                    shortcontent = table.Column<string>(type: "ntext", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsImages", x => new { x.product_id, x.image });
                    table.ForeignKey(
